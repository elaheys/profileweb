...
const Strategic = () => {
    return (
        <div className='container'>
            ...
            <div className='flex justify-center whitespace-nowrap p-2 mx-auto w-[200px] border-2 border-[#4993cc68] rounded-[10px] hover:bg-blue-400/10 transition-all cursor-pointer'>
