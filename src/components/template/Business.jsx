...
const Business = () => {
    return (
        <div className='bg-abi text-white '>
            <div className='flex justify-center items-center text-base md:text-2xl pt-12 '>
                <h3>چرا مشاوره بازاریابی و فروش ؟</h3>
            </div>

            <div className='flex child:w-full md:flex-row flex-col gap-x-10 gap-y-9 text-sm md:text-lg my-10 pb-12 mx-12 text-zinc-900 child:tracking-tightest'>
